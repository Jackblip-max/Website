      ...
      <DynamicBackground category="minimal" overlay={0.85}>
        <div className="min-h-screen flex items-center justify-center py-12 px-4">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-200 mb-6">Please login to view your applications</p>
            <button
    ...
    return (
      <DynamicBackground category="minimal" overlay={0.85}>
        <div className="min-h-screen flex items-center justify-center py-12 px-4">
          <div className="text-center max-w-md">
            <AlertCircle className="w-16 h-16 text-orange-500 mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-white mb-2">Volunteers Only</h2>
            <p className="text-gray-200 mb-6">This feature is only available for volunteers</p>
            <button
              onClick={() => navigate('/')}
              className="bg-emerald-600 text-white px-6 py-3 rounded-lg hover:bg-emerald-700 font-medium"
            >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-center py-20">
              <div className="text-center">
                <Loader />
                <p className="text-white mt-4">Loading your applications...</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-4xl font-bold text-white">{t('applications')}</h1>
            </div>
          ...
          {applications && applications.length > 0 ? (
            ...
            <div className="text-center py-20">
              <div className="max-w-md mx-auto bg-white/10 backdrop-blur-sm rounded-xl p-8">
                <Clock className="w-24 h-24 text-white/50 mx-auto mb-6" />
